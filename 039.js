...
function replaceInput( input, searchWord, replaceWord ) {
  return input.split(searchWord).join(replaceWord)
}

console.log(replaceInput( input, 'q', 'e'));

/* 문제 접근 방법
1. 3개의 매개변수를 받는 함수를 생성한다.  
2. 구분해야하는 글자 'q'를 기준으로 구분한다. split
3. 바꿀 글자인 'e'를 join한다. 
